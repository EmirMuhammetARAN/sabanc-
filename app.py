...
# Sayfa Ayarlari
st.set_page_config(page_title="NeuroVeil AI", page_icon="🧠", layout="wide", initial_sidebar_state="expanded")
...
def get_agent_report(m_prob, b_prob, final, m_top, b_top, api_key):
    ...
    prompt = f"""
    Sen uzman bir nörolog ve genetik uzmanısın. 'NeuroVeil' yapay zeka sisteminin bir asistanısın.
...
# --- UI RENDER ---
st.markdown('<p class="main-title">NeuroVeil AI 🧠</p>', unsafe_allow_html=True)
