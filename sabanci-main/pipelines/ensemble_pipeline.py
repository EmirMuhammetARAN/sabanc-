...
print("=" * 60)
print("Anti-Covid: MULTI-MODAL META-LEARNER (Gercek Modeller)")
print("=" * 60)
...
def generate_agentic_report(mri_prob, blood_prob, final_score, decision, top_mri, top_blood):
    ...
    prompt = f"""
    Sen uzman bir nörolog ve genetik uzmanısın. 'Anti-Covid' adlı yapay zeka sisteminin bir asistanısın.
    ...
    - Anti-Covid Ensemble Meta-Model Sonucu: Hastanın toplam Long COVID skoru %{final_score*100:.1f}
